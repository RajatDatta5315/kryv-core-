  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans selection:bg-emerald-500/30 pb-20 md:pb-0">
      ...
      <div className="md:hidden flex justify-between items-center p-4 border-b border-white/10 bg-black sticky top-0 z-20">
         ...
         <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className="text-emerald-500 font-bold text-xl">{mobileMenuOpen ? '✕' : '☰'}</button>
      </div>
      {mobileMenuOpen && (
      ...
      <div className="max-w-7xl mx-auto flex min-h-screen">
        <aside className="w-64 border-r border-white/5 p-6 hidden md:flex flex-col fixed h-full bg-[#09090b]">
          <div className="mb-8 flex items-center gap-2"><img src="/KRYV.png" className="h-8 w-8" /><h1 className="text-2xl font-bold tracking-widest">KRYV<span className="text-emerald-500">_</span></h1></div>
